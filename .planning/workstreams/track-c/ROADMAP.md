...
- [x] Phase 50: Message Intent Routing — smarter message handling beyond ignore/process (completed 2026-03-28)
...
**vC.1.3** - Campaign Surfaces And Intent Clarity
- **Primary Track:** Track C - Discord 交互层
- **Goal:** Make campaign/adventure/session state legible in Discord and make message handling reasons explicit to players and operators
- **Status:** Queued after vC.1.2
...
| 50. Message Intent Routing | - | Complete    | 2026-03-28 |
